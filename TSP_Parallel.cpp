...
const int MAX_N = 30; // Maximum number of cities, adjust as needed
...
#pragma omp parallel num_threads(4)
    {
        ...
        cout << "Thread " << omp_get_thread_num() << " starting computation..." << endl;
...
#pragma omp critical
            cout << "Thread " << omp_get_thread_num() << ", Iteration " << iter + 1 << ", Best distance: " << calculateDistance(population[0]) << endl;
        }
        cout << "Thread " << omp_get_thread_num() << " finished computation." << endl;
    }

    cout << "Exiting parallel region..." << endl;
